...
lib.ssMetadata = [
		{name:"FamasFinal3_atlas_", frames: [[0,1019,1022,1011],[0,0,1050,1017]]},
		{name:"FamasFinal3_atlas_2", frames: [[0,0,1415,346],[1417,0,125,177]]}
];
...
(lib.CachedTexturedBitmap_43 = function() {
	this.initialize(ss["FamasFinal3_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.4,-245.35,0.5,0.5);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(17.1,8.9,1,1,0,0,0,17.1,8.9);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.4,-245.3,525,508.5), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.cuadrado.setTransform(66,305.25,0.9852,1,0,0,0,-241,8.9);

	this.instance = new lib.CachedTexturedBitmap_43();
	this.instance.parent = this;
	this.instance.setTransform(701.55,215.25,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(435.05,180.8,0.8759,0.8752,0,0,0,13.3,-29.7);
	...
	this.movieClip_4.setTransform(187.35,346.85,0.8759,0.881,-90,0,0,13.5,-29.6);
...
(lib.FamasFinal3 = function(mode,startPosition,loop) {
	...
	this.clips.setTransform(735.4,305.2,1,1,0,0,0,735.4,305.2);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(316.8,303.7,1,1,0,0,0,316.8,303.7);
...
p.nominalBounds = new cjs.Rectangle(906.3,411,502.79999999999995,148.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal3_atlas_.png?1765064876481", id:"FamasFinal3_atlas_"},
		{src:"images/FamasFinal3_atlas_2.png?1765064876481", id:"FamasFinal3_atlas_2"}
	],
	preloads: []
};
