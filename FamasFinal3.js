...
lib.ssMetadata = [
		{name:"FamasFinal3_atlas_", frames: [[0,1517,1415,346],[0,1008,1022,507],[1024,1008,125,177],[0,0,1034,1006]]}
];
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-246.4,-246.3,0.5075,0.5075);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(16,9,1,1,0,0,0,16,9);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-246.4,-246.3,524.8,510.6), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.cuadrado.setTransform(62.85,55.65,0.9852,0.4983,0,0,0,-244.2,-240.6);

	this.instance = new lib.CachedTexturedBitmap_38();
	this.instance.parent = this;
	this.instance.setTransform(701.55,115.3,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(478.65,139.2,0.8759,0.8752,0,0,0,13.3,-29.7);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(125.05,218.95,0.8759,0.8752,75.0004,0,0,13.3,-29.6);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(228.95,208.85,0.8759,0.881,-90,0,0,13.5,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(304.3,140.8,0.8759,0.881,-44.9993,0,0,13.3,-29.7);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(165.55,119.85,0.8759,0.881,-90,0,0,13.3,-29.6);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(395.45,222.15,0.8759,0.881,180,0,0,13.3,-29.6);
...
(lib.FamasFinal3 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 565;
		var LIMITE_IZQUIERDO = 85;
	...
	this.clips.setTransform(734.9,180,1,1,0,0,0,734.9,180);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(316.8,177.7,1,1,0,0,0,316.8,177.7);
...
p.nominalBounds = new cjs.Rectangle(905.7,411,503.39999999999986,-103.80000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal3_atlas_.png?1765067435126", id:"FamasFinal3_atlas_"}
	],
	preloads: []
};
