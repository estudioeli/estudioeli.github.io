...
lib.ssMetadata = [
		{name:"FamasFinal3_atlas_", frames: [[0,0,730,270],[407,272,399,369],[732,0,49,69],[0,272,405,394]]}
];
...
(lib.Escena_1_cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(13.6,7.65,0.5,0.5);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.cuadrado.setTransform(12.65,10.05,0.386,0.3626,0,0,0,-244.1,-240.5);

	this.instance = new lib.CachedTexturedBitmap_102();
	this.instance.parent = this;
	this.instance.setTransform(228.45,37.2,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(168.35,139,0.3431,0.3429,0,0,0,13.2,-29.8);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(70.25,100.3,0.3431,0.3429,75.0014,0,0,13.3,-29.7);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(86.85,161,0.3431,0.3452,-90,0,0,13.2,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(168.35,35.75,0.3431,0.3451,-44.9982,0,0,13.3,-29.6);
...
(lib.FamasFinal3 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 202;
		var LIMITE_IZQUIERDO = 22;
		var LIMITE_INFERIOR = 190;
		var LIMITE_SUPERIOR = 10;
	...
	this.clips.setTransform(302.6,100.5,1,1,0,0,0,302.6,100.5);
	this.clips.depth = 0;
	...
	this.cuadricula.setTransform(113.4,99.9,1,1,0,0,0,113.4,99.9);
...
p.nominalBounds = new cjs.Rectangle(321.8,132.7,271.7,60.30000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal3_atlas_.png?1765238129451", id:"FamasFinal3_atlas_"}
	],
	preloads: []
};
