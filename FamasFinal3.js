...
lib.ssMetadata = [
		{name:"FamasFinal3_atlas_", frames: [[0,0,927,136],[407,138,399,216],[929,0,49,69],[0,138,405,233]]}
];
...
(lib.Escena_1_cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(120.6,7.65,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-246.3,-246.3,1.2954,1.2954);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(16,-95.4,1,1,0,0,0,16,-95.4);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-246.3,-246.3,524.7,301.8), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.cuadrado.setTransform(119.65,10.05,0.386,0.3626,0,0,0,-244.1,-240.5);

	this.instance = new lib.CachedTexturedBitmap_55();
	this.instance.parent = this;
	this.instance.setTransform(-18.5,138.7,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(221.15,40.9,0.3431,0.3429,0,0,0,13.2,-29.8);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(177.55,100.25,0.3431,0.3429,75.0014,0,0,13.3,-30.7);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(284.85,83.7,0.3431,0.3452,-90,0,0,13.2,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(275.4,35.75,0.3431,0.3451,-44.9982,0,0,13.3,-29.6);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(164.3,38.4,0.3431,0.3451,-135,0,0,13.1,-29.6);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(235.3,86.5,0.3431,0.3452,180,0,0,13.2,-29.7);
...
(lib.FamasFinal3 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 315;
		var LIMITE_IZQUIERDO = 125;
	...
	this.clips.setTransform(213.2,107.3,1,1,0,0,0,213.2,107.3);
	this.clips.depth = 0;
	...
	this.cuadricula.setTransform(220.3,61.6,1,1,0,0,0,220.3,61.6);
...
p.nominalBounds = new cjs.Rectangle(206.5,132.7,238.5,74);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal3_atlas_.png?1765539556561", id:"FamasFinal3_atlas_"}
	],
	preloads: []
};
