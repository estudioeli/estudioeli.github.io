...
lib.ssMetadata = [
		{name:"FamasFinal2_atlas_", frames: [[400,0,399,283],[0,314,841,144],[0,460,400,276],[801,0,52,73],[0,0,398,312]]}
];
...
(lib.Escena_1_cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(124.2,7.65,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-242.35,-245.6,1.0832,1.0832);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(-26.8,-76.7,1,1,0,0,0,-26.8,-76.7);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-242.3,-245.6,431.1,338), null);
...
(lib.FamasFinal2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 318;
		var LIMITE_IZQUIERDO = 135;
		var LIMITE_INFERIOR = 142;
	...
	this.clips.setTransform(219.6,125.7,1,1,0,0,0,219.6,125.7);
	this.clips.depth = 0;
	...
	this.cuadricula.setTransform(224.2,76.7,1,1,0,0,0,224.2,76.7);
...
p.nominalBounds = new cjs.Rectangle(234.3,132.5,195.5,111.30000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal2_atlas_.png?1765539366367", id:"FamasFinal2_atlas_"}
	],
	preloads: []
};
