...
lib.ssMetadata = [
		{name:"FamasFinal2_atlas_", frames: [[0,1036,595,6],[0,1028,598,6],[0,0,599,367],[0,740,589,286],[0,369,595,369],[591,740,52,73]]}
];
...
(lib.CachedTexturedBitmap_100 = function() {
	this.initialize(ss["FamasFinal2_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Escena_1_cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(11.2,7.65,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-242.1,193.5,1.0832,1.0832);

	this.instance_1 = new lib.CachedTexturedBitmap_100();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-242.3,-245.6,1.0832,1.0832);
...
(lib.ch_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-22.25,-79.75,1.3661,1.3661);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(81.7,-22.8,1,1,0,0,0,81.7,-22.8);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-242.3,-245.6,648,445.6), null);
...
(lib.ch = function(mode,startPosition,loop) {
	...
	this.Capa_1.name = "Capa_1";
	this.Capa_1.parent = this;
	this.Capa_1.setTransform(13.2,-29.9,1,1,0,0,0,13.2,-29.9);
	this.Capa_1.depth = 0;
	this.Capa_1.isAttachedToCamera = 0
	this.Capa_1.isAttachedToMask = 0
	this.Capa_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.ch, new cjs.Rectangle(-22.2,-79.7,71,99.7), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(327.4,24.8,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(244.05,68.35,0.3639,0.3636,0,0,0,13.8,-29.3);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(108.95,145.3,0.3639,0.3636,75.0072,0,0,14.1,-30.1);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(227.1,157.95,0.3639,0.366,-90,0,0,12.7,-28.8);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(43.85,70.05,0.3638,0.366,-45,0,0,13.3,-29.1);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(61.15,26.85,0.3639,0.366,-90,0,0,12.9,-28.9);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(139,61.45,0.3639,0.366,180,0,0,12.7,-29.9);

	this.cuadrado = new lib.cuadrado();
	this.cuadrado.name = "cuadrado";
	this.cuadrado.parent = this;
	this.cuadrado.setTransform(12.75,9.4,0.4616,0.4155,0,0,0,-239,-241.1);
	new cjs.ButtonHelper(this.cuadrado, 0, 1, 1);

	this.instance_1 = new lib.CachedTexturedBitmap_96();
	this.instance_1.parent = this;
	this.instance_1.setTransform(11.4,7.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.cuadrado},{t:this.movieClip_1},{t:this.movieClip_2},{t:this.movieClip_3},{t:this.movieClip_4},{t:this.movieClip_5},{t:this.movieClip_6},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Escena_1_clips, null, null);


// stage content:
(lib.FamasFinal2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 302;
		var LIMITE_IZQUIERDO = 18;
		var LIMITE_INFERIOR = 185;
	...
	this.clips.setTransform(316.6,100,1,1,0,0,0,316.6,100);
	this.clips.depth = 0;
	...
	this.cuadricula.setTransform(160,99.9,1,1,0,0,0,160,99.9);
...
p.nominalBounds = new cjs.Rectangle(321.2,132.5,300.7,60.19999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal2_atlas_.png?1765238118341", id:"FamasFinal2_atlas_"}
	],
	preloads: []
};
