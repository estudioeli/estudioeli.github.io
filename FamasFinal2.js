...
lib.ssMetadata = [
		{name:"FamasFinal2_atlas_", frames: [[1021,0,1021,774],[0,1548,1415,346],[1021,776,1018,770],[1417,1548,125,177],[0,0,1019,857]]}
];
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-242,-245.35,0.45,0.45);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(-12.8,-52.6,1,1,0,0,0,-12.8,-52.6);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-242,-245.3,458.5,385.6), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(637.5,250.75,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(457.85,222.4,0.8759,0.8752,0,0,0,13.3,-29.7);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(208.25,301.9,0.8759,0.8752,75.0004,0,0,13.3,-29.6);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(395.35,388.45,0.8759,0.881,-90,0,0,13.5,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(145.85,201.25,0.8759,0.881,-44.9993,0,0,13.3,-29.7);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(187.35,97.25,0.8759,0.881,-90,0,0,13.3,-29.6);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(374.65,180.55,0.8759,0.881,180,0,0,13.3,-29.6);
...
(lib.FamasFinal2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 560
		var LIMITE_IZQUIERDO = 75;
		var LIMITE_INFERIOR = 420;
	...
	this.clips.setTransform(703,244.7,1,1,0,0,0,703,244.7);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(315.8,243.5,1,1,0,0,0,315.8,243.5);
...
p.nominalBounds = new cjs.Rectangle(906,411,439,27.19999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal2_atlas_.png?1765067180884", id:"FamasFinal2_atlas_"}
	],
	preloads: []
};
