...
lib.ssMetadata = [
		{name:"FamasFinal2_atlas_", frames: [[426,0,424,321],[427,323,52,73],[0,0,424,357],[0,359,425,323],[0,684,588,144]]}
];
...
(lib.Escena_1_Cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(8.8,7.4,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-242.2,-245.6,1.0832,1.0832);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(-12.6,-52.2,1,1,0,0,0,-12.6,-52.2);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-242.2,-245.6,459.29999999999995,386.7), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(240.9,49.35,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(173.5,78.85,0.3639,0.3636,0,0,0,13.8,-29.3);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(69.85,112,0.3639,0.3636,75.0072,0,0,14.1,-30.1);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(147.6,147.95,0.3639,0.366,-90,0,0,12.7,-28.8);
	...
	this.cuadrado.setTransform(10.7,9.4,0.4616,0.4155,0,0,0,-239,-241.1);
	new cjs.ButtonHelper(this.cuadrado, 0, 1, 1);

	this.instance_1 = new lib.CachedTexturedBitmap_98();
	this.instance_1.parent = this;
	this.instance_1.setTransform(8.4,7.55,0.5,0.5);
...
(lib.FamasFinal2 = function(mode,startPosition,loop) {
	...
	this.clips.setTransform(271.6,88.2,1,1,0,0,0,271.6,88.2);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(114.8,87.7,1,1,0,0,0,114.8,87.7);
...
p.nominalBounds = new cjs.Rectangle(333.4,132.4,201.5,36.69999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal2_atlas_.png?1765203942988", id:"FamasFinal2_atlas_"}
	],
	preloads: []
};
