...
lib.ssMetadata = [
		{name:"FamasFinal2_atlas_", frames: [[0,0,1531,1130]]},
		{name:"FamasFinal2_atlas_2", frames: [[0,0,1528,1017],[0,1019,1527,1011]]},
		{name:"FamasFinal2_atlas_3", frames: [[0,0,1415,346],[1417,0,125,177]]}
];
...
(lib.CachedTexturedBitmap_52 = function() {
	this.initialize(ss["FamasFinal2_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedTexturedBitmap_53 = function() {
	this.initialize(ss["FamasFinal2_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.45,-245.35,0.45,0.45);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(99,8.8,1,1,0,0,0,99,8.8);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.4,-245.3,688.9,508.40000000000003), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(915.45,180.45,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(695.2,180.8,0.8759,0.8752,0,0,0,13.3,-29.7);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(276.1,426.7,0.8759,0.8752,75.0004,0,0,13.3,-29.6);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(695.1,326.05,0.8759,0.881,-90,0,0,13.5,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(187.45,248.15,0.8759,0.881,-44.9993,0,0,13.3,-29.7);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(270.55,138.85,0.8759,0.881,-90,0,0,13.3,-29.6);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(435.1,305.35,0.8759,0.881,180,0,0,13.3,-29.6);

	this.cuadrado = new lib.cuadrado();
	this.cuadrado.name = "cuadrado";
	this.cuadrado.parent = this;
	this.cuadrado.setTransform(66.05,55.1,1.1112,1,0,0,0,-239.3,-241.5);
...
(lib.FamasFinal2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 810;
		var LIMITE_IZQUIERDO = 75;
	...
	this.clips.setTransform(841.1,305.4,1,1,0,0,0,841.1,305.4);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(443.1,303.7,1,1,0,0,0,443.1,303.7);
...
p.nominalBounds = new cjs.Rectangle(904.2,411,718.8,148.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal2_atlas_.png?1765064999663", id:"FamasFinal2_atlas_"},
		{src:"images/FamasFinal2_atlas_2.png?1765064999663", id:"FamasFinal2_atlas_2"},
		{src:"images/FamasFinal2_atlas_3.png?1765064999663", id:"FamasFinal2_atlas_3"}
	],
	preloads: []
};
