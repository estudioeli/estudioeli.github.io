...
lib.ssMetadata = [
		{name:"Cronopios en html todos_atlas_", frames: [[0,983,236,262],[238,983,133,127],[0,0,981,981]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2053,496);


(lib.CachedTexturedBitmap_65 = function() {
	this.initialize(ss["Cronopios en html todos_atlas_"]);
	this.gotoAndStop(0);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-245.3,-245.3,0.5,0.5);
...
(lib.ch_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-36.9,-38.05,0.5675,0.5675);
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.3,-245.3,490.5,490.5), null);
...
(lib.ch = function(mode,startPosition,loop) {
	...
	this.Capa_1.name = "Capa_1";
	this.Capa_1.parent = this;
	this.Capa_1.setTransform(0.8,-2,1,1,0,0,0,0.8,-2);
	this.Capa_1.depth = 0;
	this.Capa_1.isAttachedToCamera = 0
	this.Capa_1.isAttachedToMask = 0
	this.Capa_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.ch, new cjs.Rectangle(-36.9,-38,75.5,72), null);
...
(lib.Escena_1_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1309.6,56.15,0.5,0.5);
	...
	this.instance_1.setTransform(598.55,53.1,0.5,0.5);
...
// stage content:
(lib.Cronopiosenhtmltodos = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		this.cuadrado = this.Capa_1.cuadrado;
		this.movieClip_1 = this.Capa_1.movieClip_1;
		this.movieClip_2 = this.Capa_1.movieClip_2;
		this.movieClip_3 = this.Capa_1.movieClip_3;
		this.movieClip_4 = this.Capa_1.movieClip_4;
		this.movieClip_5 = this.Capa_1.movieClip_5;
		this.movieClip_6 = this.Capa_1.movieClip_6;
		this.movieClip_7 = this.Capa_1.movieClip_7;
		this.movieClip_8 = this.Capa_1.movieClip_8;
		this.movieClip_9 = this.Capa_1.movieClip_9;
		this.movieClip_10 = this.Capa_1.movieClip_10;
		this.movieClip_11 = this.Capa_1.movieClip_11;
		this.movieClip_12 = this.Capa_1.movieClip_12;
		this.movieClip_13 = this.Capa_1.movieClip_13;
		this.movieClip_14 = this.Capa_1.movieClip_14;
		this.movieClip_15 = this.Capa_1.movieClip_15;
		this.movieClip_16 = this.Capa_1.movieClip_16;
		this.movieClip_17 = this.Capa_1.movieClip_17;
		this.movieClip_18 = this.Capa_1.movieClip_18;
		// ====================================================================
		// 1. CONFIGURACIÓN Y VARIABLES GLOBALES
		// ====================================================================
		
		// --- LÍMITES ZONA 1 (Derecha: Clips 1-6) ---
		var LIMITE_DERECHO = 1080;
		var LIMITE_IZQUIERDO = 605;
		var LIMITE_INFERIOR = 290;
		var LIMITE_SUPERIOR = 60;
		
		// --- LÍMITES ZONA 2 (Izquierda: Clips 7-18) ---
		var LIMITE_DERECHO18 = 540;
		var LIMITE_IZQUIERDO18 = 66;
		var LIMITE_INFERIOR18 = 530;
		var LIMITE_SUPERIOR18 = 60;
	...
	this.Capa_1.name = "Capa_1";
	this.Capa_1.parent = this;
	this.Capa_1.setTransform(842.6,298.4,1,1,0,0,0,842.6,298.4);
	this.Capa_1.depth = 0;
	this.Capa_1.isAttachedToCamera = 0
	this.Capa_1.isAttachedToMask = 0
	this.Capa_1.layerDepth = 0
...
p.nominalBounds = new cjs.Rectangle(905.1,413.1,719.9999999999999,130.60000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_64.png?1764550929100", id:"CachedTexturedBitmap_64"},
		{src:"images/Cronopios en html todos_atlas_.png?1764550929088", id:"Cronopios en html todos_atlas_"}
	],
	preloads: []
};
