...
lib.ssMetadata = [
		{name:"CronopiosHcuadr_atlas_", frames: [[0,1019,236,262],[238,1019,81,81],[0,0,1013,1017]]}
];
...
(lib.CronopiosHcuadr = function(mode,startPosition,loop) {
	...
	this.clips.setTransform(848.6,307.4,1,1,0,0,0,848.6,307.4);
	this.clips.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(905,413.1,732.5,148.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_26.png?1764766860893", id:"CachedTexturedBitmap_26"},
		{src:"images/CachedTexturedBitmap_28.png?1764766860893", id:"CachedTexturedBitmap_28"},
		{src:"images/CronopiosHcuadr_atlas_.png?1764766860882", id:"CronopiosHcuadr_atlas_"}
	],
	preloads: []
};
