...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1139.15,77.25,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_71.png?1765062879992", id:"CachedTexturedBitmap_71"},
		{src:"images/CachedTexturedBitmap_73.png?1765062879992", id:"CachedTexturedBitmap_73"},
		{src:"images/CronopiosHcuadr_atlas_.png?1765062879981", id:"CronopiosHcuadr_atlas_"}
	],
	preloads: []
};
