...
lib.ssMetadata = [
		{name:"FamasFinal1_atlas_", frames: [[0,1019,1519,1017],[0,0,1519,1017]]},
		{name:"FamasFinal1_atlas_2", frames: [[0,1013,1415,346],[0,0,1515,1011],[1417,1013,125,177]]}
];
...
(lib.CachedTexturedBitmap_13 = function() {
	this.initialize(ss["FamasFinal1_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.45,-245.35,0.5,0.5);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(134.3,8.9,1,1,0,0,0,134.3,8.9);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.4,-245.3,759.5,508.5), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(905.85,382.8,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(395.45,430.4,0.8759,0.8752,0,0,0,13.3,-29.7);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(151.3,391.8,0.8759,0.8752,75.0004,0,0,13.3,-29.6);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(478.55,117.2,0.8759,0.881,-90,0,0,13.5,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(612,430.05,0.8759,0.881,-44.9993,0,0,13.3,-29.7);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(145.75,159.65,0.8759,0.881,-90,0,0,13.3,-29.6);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(653.6,242.85,0.8759,0.881,180,0,0,13.3,-29.6);

	this.cuadrado = new lib.cuadrado();
	this.cuadrado.name = "cuadrado";
	this.cuadrado.parent = this;
	this.cuadrado.setTransform(66.05,55.1,1,1,0,0,0,-239.3,-241.5);
...
(lib.FamasFinal1 = function(mode,startPosition,loop) {
	...
	this.clips.setTransform(836.6,305.4,1,1,0,0,0,836.6,305.4);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(440.1,303.7,1,1,0,0,0,440.1,303.7);
...
p.nominalBounds = new cjs.Rectangle(904.9,411,708.5000000000001,148.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal1_atlas_.png?1765067075376", id:"FamasFinal1_atlas_"},
		{src:"images/FamasFinal1_atlas_2.png?1765067075376", id:"FamasFinal1_atlas_2"}
	],
	preloads: []
};
