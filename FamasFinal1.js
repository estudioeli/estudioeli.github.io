...
lib.ssMetadata = [
		{name:"FamasFinal1_atlas_", frames: [[0,0,1202,370],[0,743,836,130],[0,372,1202,369],[838,743,50,70],[1204,0,404,406]]}
];
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.3,-245.3,1.2524,1.2524);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(7.7,8.9,1,1,0,0,0,7.7,8.9);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.3,-245.3,506,508.5), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.cuadrado.setTransform(413.3,9.7,0.3992,0.3637,0,0,0,-238.8,-241);

	this.cuadrado_1 = new lib.cuadrado();
	this.cuadrado_1.name = "cuadrado_1";
	this.cuadrado_1.parent = this;
	this.cuadrado_1.setTransform(213.2,9.7,0.3992,0.3637,0,0,0,-238.8,-241);

	this.instance = new lib.CachedTexturedBitmap_92();
	this.instance.parent = this;
	this.instance.setTransform(111.45,185.2,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(303.3,55.1,0.3497,0.3183,0,0,0,14,-29.2);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(139.9,121.6,0.3207,0.3474,0,76.291,73.6165,14.1,-30);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(353.2,106.35,0.3185,0.3517,-90,0,0,12.8,-29.2);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(409.65,60.65,0.3344,0.3364,0,-47.6677,-42.3352,13.1,-29.1);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(139.95,45.75,0.3185,0.3517,-90,0,0,12.7,-29.2);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(220.3,100.6,0.3497,0.3204,180,0,0,12.6,-30.1);

	this.cuadrado_2 = new lib.cuadrado();
	this.cuadrado_2.name = "cuadrado_2";
	this.cuadrado_2.parent = this;
	this.cuadrado_2.setTransform(13.6,9.7,0.3992,0.3637,0,0,0,-238.8,-241);

	this.instance_1 = new lib.CachedTexturedBitmap_91();
	this.instance_1.parent = this;
	this.instance_1.setTransform(11.6,8.2,0.5,0.5);
...
(lib.FamasFinal1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 610;
		var LIMITE_IZQUIERDO = 17;
	...
	this.clips.setTransform(311.9,129.2,1,1,0,0,0,311.9,129.2);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(311.7,99.9,1,1,0,0,0,311.7,99.9);
...
p.nominalBounds = new cjs.Rectangle(321,132.7,291.70000000000005,117.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal1_atlas_.png?1765238108580", id:"FamasFinal1_atlas_"}
	],
	preloads: []
};
