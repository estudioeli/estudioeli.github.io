...
lib.ssMetadata = [
		{name:"FamasFinal1_atlas_", frames: [[0,421,624,417],[0,1259,582,143],[0,840,624,417],[584,1259,52,73],[0,0,625,419]]}
];
...
(lib.Escena_1_Cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(10.35,7.85,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.8,-245.8,1.2155,1.2155);
...
(lib.ch_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-22.2,-79.7,1.3797,1.3797);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(134.1,8.8,1,1,0,0,0,134.1,8.8);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.8,-245.8,759.7,509.3), null);
...
(lib.ch = function(mode,startPosition,loop) {
	...
	this.Capa_1.name = "Capa_1";
	this.Capa_1.parent = this;
	this.Capa_1.setTransform(13.7,-29.4,1,1,0,0,0,13.7,-29.4);
	this.Capa_1.depth = 0;
	this.Capa_1.isAttachedToCamera = 0
	this.Capa_1.isAttachedToMask = 0
	this.Capa_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.ch, new cjs.Rectangle(-22.2,-79.7,71.8,100.7), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(330.75,61.35,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(147.95,164.25,0.3603,0.36,0,0,0,13.6,-29.4);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(47.55,148.35,0.3603,0.36,75.0018,0,0,13.7,-29.7);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(182.05,35.4,0.3603,0.3624,-90,0,0,13.3,-29.6);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(236.9,164.1,0.3603,0.3624,-44.9983,0,0,13.2,-29.4);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(45.2,52.85,0.3603,0.3624,-90,0,0,13.2,-29.4);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(254.1,87.05,0.3603,0.3624,180,0,0,13.1,-29.9);

	this.cuadrado = new lib.cuadrado();
	this.cuadrado.name = "cuadrado";
	this.cuadrado.parent = this;
	this.cuadrado.setTransform(12.4,9.9,0.4113,0.4113,0,0,0,-239.1,-241.3);

	this.instance_1 = new lib.CachedTexturedBitmap_83();
	this.instance_1.parent = this;
	this.instance_1.setTransform(10.55,8.5,0.5,0.5);
...
(lib.FamasFinal1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 312;
		var LIMITE_IZQUIERDO = 18;
		var LIMITE_INFERIOR = 210;
		var LIMITE_SUPERIOR = 18;
	...
	this.clips.setTransform(315.7,112.8,1,1,0,0,0,315.7,112.8);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(166.3,112.1,1,1,0,0,0,166.3,112.1);
...
p.nominalBounds = new cjs.Rectangle(334.7,132.9,287.09999999999997,84.69999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal1_atlas_.png?1765203518908", id:"FamasFinal1_atlas_"}
	],
	preloads: []
};
