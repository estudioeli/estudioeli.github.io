...
lib.ssMetadata = [
		{name:"FamasFinal1_atlas_", frames: [[0,408,607,371],[0,1152,836,130],[0,781,607,369],[609,408,50,70],[0,0,608,406]]}
];
...
(lib.Escena_1_Cuadricula = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(63.2,7.65,0.5,0.5);
...
(lib.cuadrado_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-245.4,-245.3,1.2524,1.2524);
...
(lib.ch_Capa_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-22.2,-79.75,1.4217,1.4217);
...
(lib.cuadrado = function(mode,startPosition,loop) {
	...
	this.Capa_1.setTransform(135.3,8.9,1,1,0,0,0,135.3,8.9);
	this.Capa_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.cuadrado, new cjs.Rectangle(-245.4,-245.3,761.5,508.5), null);
...
(lib.ch = function(mode,startPosition,loop) {
	...
	this.Capa_1.name = "Capa_1";
	this.Capa_1.parent = this;
	this.Capa_1.setTransform(13.3,-30,1,1,0,0,0,13.3,-30);
	this.Capa_1.depth = 0;
	this.Capa_1.isAttachedToCamera = 0
	this.Capa_1.isAttachedToMask = 0
	this.Capa_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.ch, new cjs.Rectangle(-22.2,-79.7,71.1,99.5), null);
...
(lib.Escena_1_clips = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,185.2,0.5,0.5);

	this.movieClip_6 = new lib.ch();
	this.movieClip_6.name = "movieClip_6";
	this.movieClip_6.parent = this;
	this.movieClip_6.setTransform(333.2,39.95,0.3497,0.3183,0,0,0,14,-29.2);

	this.movieClip_5 = new lib.ch();
	this.movieClip_5.name = "movieClip_5";
	this.movieClip_5.parent = this;
	this.movieClip_5.setTransform(191.95,121.6,0.3207,0.3474,0,76.291,73.6165,14.1,-30);

	this.movieClip_4 = new lib.ch();
	this.movieClip_4.name = "movieClip_4";
	this.movieClip_4.parent = this;
	this.movieClip_4.setTransform(103,161.15,0.3185,0.3517,-90,0,0,13.3,-29.7);

	this.movieClip_3 = new lib.ch();
	this.movieClip_3.name = "movieClip_3";
	this.movieClip_3.parent = this;
	this.movieClip_3.setTransform(303.65,132.65,0.3344,0.3364,0,-47.6677,-42.3352,13.1,-29.1);

	this.movieClip_2 = new lib.ch();
	this.movieClip_2.name = "movieClip_2";
	this.movieClip_2.parent = this;
	this.movieClip_2.setTransform(191.9,45.75,0.3185,0.3517,-90,0,0,12.7,-29.2);

	this.movieClip_1 = new lib.ch();
	this.movieClip_1.name = "movieClip_1";
	this.movieClip_1.parent = this;
	this.movieClip_1.setTransform(246.8,40,0.3497,0.3204,180,0,0,12.6,-30.1);

	this.cuadrado = new lib.cuadrado();
	this.cuadrado.name = "cuadrado";
	this.cuadrado.parent = this;
	this.cuadrado.setTransform(65.6,9.7,0.3992,0.3637,0,0,0,-238.8,-241);

	this.instance_1 = new lib.CachedTexturedBitmap_16();
	this.instance_1.parent = this;
	this.instance_1.setTransform(63.6,8.2,0.5,0.5);
...
(lib.FamasFinal1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var LIMITE_DERECHO = 358;
		var LIMITE_IZQUIERDO = 70;
		var LIMITE_INFERIOR = 188;
		var LIMITE_SUPERIOR = 12;
	...
	this.clips.setTransform(209,129.2,1,1,0,0,0,209,129.2);
	this.clips.depth = 0;
	...
	this.Cuadricula.setTransform(215,99.9,1,1,0,0,0,215,99.9);
...
p.nominalBounds = new cjs.Rectangle(225,132.7,193,117.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/FamasFinal1_atlas_.png?1765538986057", id:"FamasFinal1_atlas_"}
	],
	preloads: []
};
