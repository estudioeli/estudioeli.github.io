...
lib.ssMetadata = [
		{name:"CronopiosH_atlas_", frames: [[0,983,236,262],[238,983,133,127],[0,0,981,981]]}
];
...
(lib.CachedTexturedBitmap_69 = function() {
	this.initialize(ss["CronopiosH_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.CronopiosH = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedTexturedBitmap_68.png?1764551099265", id:"CachedTexturedBitmap_68"},
		{src:"images/CronopiosH_atlas_.png?1764551099256", id:"CronopiosH_atlas_"}
	],
	preloads: []
};
